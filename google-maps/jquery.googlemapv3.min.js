...
*/
(function(a){a.fn.googlemapv3=function(b){var c={aData:null,center:null,type:google.maps.MapTypeId.ROADMAP,kml:null},d=a.extend(c,b),e=function(a){function g(a,b){var e=new google.maps.InfoWindow({content:d.aData[a].info}),f=new google.maps.Marker({position:new google.maps.LatLng(d.aData[a].lat,d.aData[a].lng),map:c,title:d.aData[a].title});google.maps.event.addListener(f,"click",function(){e.open(c,f)})}var b={zoom:d.center.zoom,center:new google.maps.LatLng(d.center.lat,d.center.lng),mapTypeId:d.type},c=new google.maps.Map(a[0],b);a.data({map:c});for(var e=0;e<d.aData.length;e++)g(e);if(d.kml!=null){var f=new google.maps.KmlLayer(d.kml);f.setMap(c)}};return this.each(function(){e(a(this))}),this}})(jQuery)